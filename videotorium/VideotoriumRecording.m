...
{
    return [NSString stringWithFormat:@"VideotoriumRecording (ID: %@, title: %@, dateString: %@, eventName: %@, indexPictureURL: %@, resultsOnSlides: %@)", self.ID, self.title, self.dateString, self.eventName, self.indexPictureURL, self.matchingSlides];
}
