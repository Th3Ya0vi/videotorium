...
- (void)layout {
    ...
    if (UIInterfaceOrientationIsLandscape([self interfaceOrientation])) {
        [self.moviePlayerController.view setFrame:CGRectMake(0, height/4, width/2, height/2)];
        [self.slideImageView setFrame:CGRectMake(width/2, height/4, width/2, height/2)];
    } else {
